...
// ListCodecsRequest is the request for ListCodecs.
...
// "encrypted:<inner>" (e.g. "encrypted:json").
//
// The payload is intentionally minimal (names only). When richer metadata is
// needed (e.g. inner codec, encryption family, max value size), add a new
// `repeated CodecInfo codec_info = 2;` field — keep `codecs` for clients
